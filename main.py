...
from utils.crud import show, add_user,search,remove_user,update_user,map_single_users, map_all_users
from utils.crud_db import show_users, remove_users_from_db, get_users(db_params), update_users, add_users, get_user_id
if __name__ == '__main__':
    ...
    while True:
        ...
        if menu_option == '2': update_users(db_params)
